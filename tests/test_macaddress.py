...
class TestFunctions(TestCase):
    ...
    def test_cache_with_creation(self):
        ...
        """
        local_test_mac = MacAddress(SAMPLE_EUI48.mac, oui_cache=TEST_CACHE)
        self.assertEqual(local_test_mac.ieee_record, TEST_RECORD)
    ...
    """
    Test the various MAC Properities
    """
    ...
    def test_mac_period(self):
        self.assertEqual(self.mac48.period, '6026.AABB.99CC')
        self.assertEqual(self.mac64.period, '0011.AA00.00BB.99DD')

...
TEST_OUI_DICT = {
    i: {
        TEST_OUI_STRING[i]: {
            "vendor": TEST_VENDOR[i],
            "oui": TEST_OUI_STRING[i],
            "address": "ADDRESS INFO",
        }
    }
    for i in TEST_VENDOR
}
...
URL_MOCK = Mock()
URL_MOCK.status = 200
URL_MOCK.read.return_value = (
    b'{"success":true,"found":true,"macPrefix":"AA0000","company":"Test GET"}'
)
...
SAMPLE_EUI48 = TestMac(
    "24:6D:5E:BB:99:CC", 1001000110110101011110101110111001100111001100, 40052159388108
)

SAMPLE_EUI64 = TestMac(
    "24:6D:5E:00:00:BB:99:DD",
